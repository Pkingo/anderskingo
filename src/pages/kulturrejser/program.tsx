  ...
  <React.Fragment>
    <div className="kulturrejser-program">
      ...
      <div className="kulturrejser-left-section">
        <h6 className="no-space-bottom">Første dag (6. juni)</h6>
        <p>
          Kastrup (afgang 10.10) - Thessaloniki (ankomst 15.20) – Kavala
          Rejsedag, der slutter med indkvartering, afslapning og middag på Hotel
          Lucy Kavala.
        </p>
        <h6 className="no-space-bottom">Anden dag (7. juni)</h6>
        <p>
          ...
          næststørste by. Vi hører byens historie, besøger Demitrios Kirken og
        ...
        <h6 className="no-space-bottom">Tredje dag (8. juni) </h6>
        <p>
          Vergina – Kalambaka
          <br />I Vergina fandt en græsk arkæolog for godt 50 år siden Filip
          II’s imponerende gravkammer. På stedet er der nu bygget et lige så
          ...
          den kære Theodora på Hotel Kaiki. Får vi tid, besøger vi allerede
          inden ankomsten til hotellet »de svævende klostre«, Meteora.
        </p>
        <img src={Hellas2} alt="Hellas" className="kulturrejser-image" />
        <h6 className="no-space-bottom">Fjerde dag (9. juni) </h6>
        <p>
          ...
          bus op ad nordsiden af bjergmassivet Parnassos, på hvis sydside Delphi
          ligger. Efter frokost besøger vi tempelplads, orakel, stadion og
          museum i Delphi. Derefter besøger vi juveleren Christos og kører så de
          16 km ned til havnebyen Itea ved den korintiske bugt. Her indkvarteres
          vi på Hotel Nafsika.
        </p>
        <img src={Hellas3} alt="Hellas" className="kulturrejser-image" />
        <h6 className="no-space-bottom">Femte dag (10. juni)</h6>
        <p>
          ...
          bygget dér, hvor apostlen Andreas led martyrdøden. Derefter kører vi
          de 135 km ned til Olympia, hvor en perle af et hotel venter os med
          spænding: Olympion Asty.
        </p>
      </div>
      <div className="kulturrejser-right-section">
        <h6 className="no-space-bottom">Sjette dag (11. juni)</h6>
        <p>
        ...
        <h6 className="no-space-bottom">Syvende dag (12. juni)</h6>
        <p>
          Mystras – Tolo
          <br />
        ...
        <h6 className="no-space-bottom">Ottende dag (13. juni)</h6>
        <p>
          Epidauros – Nafplion
          <br />
          ...
          hvor der er mulighed for på egen hånd at se byens stolthed: en
          veneziansk borg. Derefter venter os atter Demitris’ charme.
        </p>
        <h6 className="no-space-bottom">Niende dag (14. juni)</h6>
        <p>
          ...
          korintiske kanal. I Athen indkvarteres vi i bymidten på Hotel Amalia,
          lige ved siden af Syntagma Pladsen med det græske parlament.
        </p>
        <img src={Hellas4} alt="Parthenon" className="kulturrejser-image" />
        <h6 className="no-space-bottom">Tiende dag (15. juni)</h6>
        <p>
          Athen
          ...
          Athens gamle bydel Plaka ligger i gåafstand derfra.
        </p>
        <h6 className="no-space-bottom">Elvte dag (16. juni)</h6>
        <p>
          NNationalmuseet står øverst på dagsordenen denne dag, men vi får også
        ...
        <h6 className="no-space-bottom">Tolvte dag (17. juni) </h6>
        <p>Athen (14.35) – Kastrup (19.20). Hjemrejsedag.</p>
        <h6 className="no-space-bottom">
